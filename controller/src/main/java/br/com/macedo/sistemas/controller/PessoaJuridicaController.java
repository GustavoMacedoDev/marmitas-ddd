...
import br.com.macedo.sistemas.domain.dto.CadastroPjDto;
...
public class PessoaJuridicaController {
	...
	public ResponseEntity<Response<CadastroPjDto>> cadastrar(@Validated @RequestBody CadastroPjDto cadastroPjDto,
		...
		this.pessoaJuridicaService.persistir(pessoaJuridica);

		return ResponseEntity.ok(response);
	}

	private void validarDadosExistentes(CadastroPjDto cadastroPJDto, BindingResult result) {
		this.pessoaJuridicaService.buscarPorCnpj(cadastroPJDto.getCnpj())
